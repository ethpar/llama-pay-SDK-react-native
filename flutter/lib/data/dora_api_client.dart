...
class DoraApiClient {
  ...
  DoraApiClient() {
    ...
    dio = Dio(BaseOptions(baseUrl: doraUrl, headers: headers));
  }
  ...
  Future<ERC20TransactionListResponse> getERC20Transactions(
    ...
    return ERC20TransactionListResponse.fromJson(response.data);
  }
}
    ...
    return TransactionListResponse(
      data:
          (json['data'] as List<dynamic>)
              .map(
                (item) =>
                    NativeTransaction.fromJson(item as Map<String, dynamic>),
              )
              .toList(),
    ...
    return ERC20TransactionListResponse(
      data:
          (json['data'] as List<dynamic>)
              .map(
                (item) =>
                    ERC20Transaction.fromJson(item as Map<String, dynamic>),
              )
              .toList(),
      totalCount: json['totalCount'] as int,
      pageSize: json['pageSize'] as int,
