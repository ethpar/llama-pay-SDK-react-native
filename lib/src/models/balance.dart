...
class TokenPrice {
  ...
  factory TokenPrice.fromJson(Map<String, dynamic> json) {
    return TokenPrice(
      ...
      priceChangePercentange24h: (json['priceChangePercentange24h'] as num).toDouble(),
    );
  }
...
class Balance {
  ...
  factory Balance.fromJson(Map<String, dynamic> json) {
    return Balance(
      ...
      priceChangePercentange24h: json['priceChangePercentange24h'] != null 
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (priceChangePercentange24h != null) 'priceChangePercentange24h': priceChangePercentange24h,
    };
  }
}
